    ...
    function process($server_path = null) {
        ...
        if ($this->processed) {
            ...
            if ($this->file_safe_name) { // formats the name
                $this->file_dst_name_body = utf8_encode(strtr(utf8_decode($this->file_dst_name_body), utf8_decode('?????AAAAAACEEEEIIIINOOOOO¨ªUUUUYaaaaaaceeeeiiiinooooo©ªuuuuyy'), 'SZszYAAAAAACEEEEIIIINOOOOOOUUUUYaaaaaaceeeeiiiinoooooouuuuyy'));
                $this->file_dst_name_body = strtr($this->file_dst_name_body, array('¨­' => 'TH', '©­' => 'th', '¨¢' => 'DH', '©£' => 'dh', '©¬' => 'ss', '¨«' => 'OE', '©«' => 'oe', '¨¡' => 'AE', '©¡' => 'ae', '¥ì' => 'u'));
